...
% Texte 1
uicontrol('style','text','parent',trans1,'position',[15 70 200 20],'string','Translation par rapport à X :'...
...
tx12=uicontrol('style','edit','parent',trans1,'position',[250 73 70 20],'backgroundcolor',[1 1 1]...
    ,'string','0','fontsize',10,'tooltipstring','Translation par rapport à X');
% Texte 2
uicontrol('style','text','parent',trans1,'position',[15 25 200 20],'backgroundcolor',[1 1 1]...
    ,'string','Translation par rapport à Y :','fontsize',10,'Fontangle','Italic');
% Valeur 2
ty12=uicontrol('style','edit','parent',trans1,'position',[250 28 70 20],'backgroundcolor',[1 1 1]...
    ,'string','0','fontsize',10,'tooltipstring','Entrez la coordonnée verticale');
