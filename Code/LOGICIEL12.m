...
% %**************************************************************************
 ...
 global Texte1 Texte2 Texte3 Texte4 Texte5
...
% %**************************************************************************
 F=figure('name','Mise en correspondance','position',pos,'menubar','none'...
         ,'color',[1 1 1],'resize','off');
     [x,map]=imread('C:\Users\new\Documents\USTO\Master 2\SIVR\PFE\Nouveau dossier\a.png');
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% 
% text(10,75,'Université des Sciences et de la Technologie d''ORAN -USTO- ',...
%     'Fontname','Arial','Fontsize',15,'Fontangle','Italic','Fontweight','Bold','color',[.33 .725 .84]);
% 
% text(175,100,'Département d''Electronique','Fontname','Arial','Fontsize',13,...
%          'Fontangle','Italic','Fontweight','Bold','color',[.608 .84 .92]);
%      
% text(85,140,'"Mise en correspondance des images médicales',...
%     'Fontname','Arial','Fontsize',15,'Fontangle','Italic','Fontweight','Bold','color',[.33 .725 .84]);
% text(145,165,'Pour la Radiothérapie des tumeurs"','Fontname','Arial','Fontsize',15,...
...
%*****************************MENU FICHIER*********************************
 f1=uimenu(F,'label','&Fichier','foregroundcolor',[0 0 0],'accelerator','o');            
...
% %*****************************MENU IMAGE***********************************
f2=uimenu(F,'label','&Image','foregroundcolor',[0 0 0]);            
...
%*****************************MENU PRETRAITEMENT***************************
f4=uimenu(F,'label','&Prétraitement','foregroundcolor',[0 0 0]);
...
%         ,'separator','on','callback','bruits');
    ...
    f46=uimenu(f4,'label','&Filtrage','foregroundcolor',[0 0 0]...
        ,'callback','filtrage');
% %*****************************MENU SEGMENTATION****************************
f5=uimenu(F,'label','&Segmentation','foregroundcolor',[0 0 0]);
...
%*****************************MENU RECALAGE********************************
f6=uimenu(F,'label','&Pré-Recalage','foregroundcolor',[0 0 0]);
    ...
    f7=uimenu(F,'label','&Recalage','foregroundcolor',[0 0 0]);
